...
<body>
    <nav class="navbar navbar-dark bg-dark">
            <span class="navbar-brand mb-0 h1"> DATA PESERTA 2020</span>
        </div>
    </nav>
<div class="container">
    <br>
...
?>
    ...
    <a href="create.php" class="btn btn-primary" role="button" style="background-color: rgb(255, 192, 203); color: black;">Submit</a>
</div>
</body>
</html>
